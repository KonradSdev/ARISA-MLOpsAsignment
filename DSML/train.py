...
def train(X_train:pd.DataFrame, y_train:pd.DataFrame, categorical_indices:list[int],  # noqa: PLR0913
          params:dict|None, artifact_name:str="catboost_model_heart_risk", cv_results=None,
          )->tuple[str|Path]:
...
def get_or_create_experiment(experiment_name:str):
    ...
    return mlflow.create_experiment(experiment_name,"s3://mlops-arisa-mlflow-artifacts/models")
...
if __name__=="__main__":
    ...
    experiment_id = get_or_create_experiment("heart_risk_hyperparam_tuning")
    ...
    experiment_id = get_or_create_experiment("heart_risk_full_training")
    mlflow.set_experiment(experiment_id=experiment_id)
